...
export function parseDlsiteProductJson(raw: unknown): DlsiteProductInfo | null {
  ...
  if (!workno || !workName || !isValidDlsiteWorkno(workno)) return null;
  return {
    workno: workno.toUpperCase(),
    work_name: workName,
    maker_name:
      typeof rec.maker_name === "string"
        ? rec.maker_name
        : rec.maker_name === null
          ? null
          : undefined,
    series_id:
      typeof rec.series_id === "string"
        ? rec.series_id
        : rec.series_id === null
          ? null
          : undefined,
