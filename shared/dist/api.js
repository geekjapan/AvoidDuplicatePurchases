import { z } from "zod";
import { SOURCES, LIBRARY_SOURCES, LIBRARY_ITEM_STATES, isCanonicalLibraryPageUrl, isLibraryCid, isCanonicalLibraryProductUrl, } from "./identity.js";
...
const LibraryImportByStateSchema = z
    .object(Object.fromEntries(LIBRARY_ITEM_STATES.map((state) => [state, z.number().int().nonnegative()])))
    .strict();
